...
import { msgraphLibType, reportDiagnostic } from "./msgraph.js";
...
export async function $onEmit(p: Program, emitterOptions?: EmitOptionsFor<msgraphLibType>) {
  const options: CsdlEmitterOptions = {
    outputFile: resolvePath("./model.csdl"),
  };
